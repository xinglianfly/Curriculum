...
public class OmniScrollView extends FrameLayout {
    ...
    public OmniScrollView(Context context) {
        this(context, null);
    }

    public OmniScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initScrollView();
    }
...
//    }
    ...
    public boolean isNeedMove(boolean flag){
    ...
    private OmniScrollListener scrollViewListener;
    
    
    /**
     * 当omniview滑动的时候，无论是用户触发还是程序触发，都将调用这个函数
     */
    @Override
	...
	public OmniScrollListener getScrollViewListener() {
		return scrollViewListener;
	}

	public void setScrollViewListener(OmniScrollListener scrollViewListener) {
